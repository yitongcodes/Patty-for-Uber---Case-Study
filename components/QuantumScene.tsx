...
// Fix for JSX intrinsic element errors by defining them as typed components to avoid JSX.IntrinsicElements missing property errors
...
const MacroscopicWave = () => {
  ...
  return (
    <Torus ref={ref} args={[3, 0.1, 16, 100]} rotation={[Math.PI / 2, 0, 0]}>
      {/* Fix: Using capitalized MeshStandardMaterial to avoid JSX intrinsic element errors */}
  ...
  return (
    <div className="absolute inset-0 z-0 opacity-60 pointer-events-none">
      <Canvas camera={{ position: [0, 0, 6], fov: 45 }}>
        {/* Fix: Using capitalized Light components to avoid JSX intrinsic element errors */}
    ...
    <div className="w-full h-full absolute inset-0">
      <Canvas camera={{ position: [0, 0, 4.5], fov: 45 }}>
        ...
        <Float rotationIntensity={0.4} floatIntensity={0.2} speed={1}>
          {/* Fix: Using capitalized Group to avoid JSX intrinsic element errors */}
